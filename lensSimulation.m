...
focalLength = 100;
z1 = -200;
% assuming the lens is positioned at 0, have thickness of zero
%z2 = -1 * z1;
...
rays_ypos = [1 1 1];
rays_angle = [0 atan(1/z1) atan(2/z1)];
...
function z2 = solveZ2(z1, rayIn, mf)
...
%
    mz1 = [1,z1;0,1];
    UMtemp = mf * mz1;
    [rayOut,thetaOut] = simRayProp(UMtemp,[1],[0]);
end
